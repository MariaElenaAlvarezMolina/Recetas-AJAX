...
class Recipe:
    ...
    def save(cls, formulario):
        query = "INSERT INTO recipes (name, description, instruction, date_made, under_30, user_id, image) VALUES (%(name)s, %(description)s, %(instruction)s, %(date_made)s, %(under_30)s, %(user_id)s, %(image)s)"
